          ...
          <div className="pvdf-intro-grid">
            ...
            >
              <div className="pvdf-intro-card">
                ...
                <div className="pvdf-card-content">
                  <p>
                    Pvc Sch-40 and Sch-80 and Cpvc Sch-80, Polyproplene and HDPE Pipes, Fittings, 
                    And Valves, For Plumbing, Industrial, Electrical and Irrigation Usage.
                  </p>
                  <p>
                    These piping systems meet rigorous ASTM and NEMA standards, ensuring reliability, 
                    durability, and performance in demanding environments. Available in various 
                    specifications, colors, and socket types to suit specific project requirements.
                  </p>
                  {/* <p>
                  ...
                  <p className="font-medium text-gray-900">
                    Our comprehensive range includes products manufactured to international quality standards, 
                    available in standard lengths for immediate delivery and installation.
                  </p>
                  {/* <p>
            ...
            >
              ...
              >
                ...
                >
                  <p className="pvdf-image-title">PVC Pipes</p>
                  <p className="pvdf-image-subtitle">Schedule 40 & 80</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  <p className="pvdf-image-title">Fittings</p>
                  <p className="pvdf-image-subtitle">Complete Range</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  <p className="pvdf-image-title">CPVC Systems</p>
                  <p className="pvdf-image-subtitle">High Temperature</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  <p className="pvdf-image-title">Valves</p>
                  <p className="pvdf-image-subtitle">Precision Control </p>
                </motion.div>
              </motion.div>
